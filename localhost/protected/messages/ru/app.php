...
return [
	'Школярам' => 'Школьники',
    'ВНО' => 'ЗНО',
    'Загальний розмовний курс' => 'Общий раговорный курс',
	...
	//call_user_func($foo) => call_user_func(funcr),
    ...
    'Курси' => 'Курсы',
    'Контакти' => 'Контакты',
    'Вік: 6-16' => 'Возраст: 6-16',
    'Вступ до ВНЗ' => 'Поступление в ВУЗы',
    'Вік: 14-99' => 'Возраст: 14-99',
    'Співбесіда, переписка, технічний тд.' => 'Собеседование, переписка, технический т.д.',
    'IELTS, TOEFL, etc.' => 'IELTS, TOEFL, etc.',
    'Працюємо вже більше 9 років' => 'Работаем уже более 9 лет',
    'Навчання у професійних викладачів' => 'Обучение у профессиональных преподавателей',
    'Дружня атмосфера' => 'Дружественная атмосфера',
    'Безліч курсів' => 'Множество курсов',
    'Підготовка до міжнародних іспитів' => 'Подготовка к международным экзаменам',
    'Speaking Club, переклади, юридичним особам тд.' => 'Speaking Club, переводы, юридическим лицам тд.',
    ...
    'No' => 'Нет',
	'TEST' => 'TEEEEST',
	'<?php echo TemplateBlock::model()->findByPk(TemplateBlock::GREN_BLOCK_HOME)->content; ?>' => '<?php echo TemplateBlock::model()->findByPk(TemplateBlock::GREN_BLOCK_HOME)->content_ru; ?>',
    'Вік: 6-16' => 'Возраст: 6-16',
